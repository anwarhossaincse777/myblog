                                    ...
                                    <form action="{{route('post.update',[$post->id])}}" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select name="category" id="category" class="form-control">
                                                    ...
                                                    @foreach($categories as $c)
                                                        ...
                                                        <option value="{{$c->id}}" @if($post->category_id==$c->id) selected @endif>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea name="description" id="description" class="form-control" placeholder="Enter Description">{{$post->description}}</textarea>
                                            </div>
